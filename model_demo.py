...
df = pd.read_csv('/Users/youshu_/Python_Workspace/KwaiSurvival-Test-Demo/example_data.csv')
print(df)
label = 'Time'
event = 'Event'
...
# 模型summary
ds.model.summary()
print(ds.X.shape) # 1019 ,4
#
# # 模型保存 - 这里代码没写，感觉这版代码是个实验版本的
# ds.model.save('/Users/youshu_/Python_Workspace/KwaiSurvival-Test-Demo/model_save/path_to_my_model_DeepSurv.h5')
# # ds.model.save('/Users/youshu_/Python_Workspace/KwaiSurvival-Test-Demo/model_save/path_to_my_model_DeepHit.h5')
# # ds.model.save('/Users/youshu_/Python_Workspace/KwaiSurvival-Test-Demo/model_save/path_to_my_model_DeepMultiTasks.h5')
#
...
print(survival_function.shape) # 100*1019
